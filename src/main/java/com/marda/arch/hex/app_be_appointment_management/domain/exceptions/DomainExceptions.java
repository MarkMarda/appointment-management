package com.marda.arch.hex.app_be_appointment_management.domain.exceptions;
...
public class DomainExceptions extends Exception {
     ...
     * @since 1.7
     */
    public DomainExceptions(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
